. "${XDG_CONFIG_HOME:-$HOME/.config}"/env.d/_init
. "${XDG_CONFIG_HOME:-$HOME/.config}"/env.d/_login
. "${XDG_CONFIG_HOME:-$HOME/.config}"/env.d/_xdg
. "${XDG_CONFIG_HOME:-$HOME/.config}"/env.d/[!_.]* 2>/dev/null
